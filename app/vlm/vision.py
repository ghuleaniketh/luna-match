...
class LunarVisionEngine:
    ...
    def explain_registration(
        ...
        # Collect available images (prioritize overlay image to remain well within API token limits)
        images = []
        if overlay_image is not None:
            images.append(overlay_image)
        elif source_image is not None and reference_image is not None:
            images.extend([source_image, reference_image])
