...
export default function App() {
  ...
  return (
    <div className={`app-shell relative flex min-h-screen flex-col bg-[#09090b] text-zinc-100${isSiteReady ? ' app-shell--ready' : ''}`}>
      <SiteLoader onReady={() => setIsSiteReady(true)} />
      ...
      <main className="relative z-10 flex-1 site-content">
        <Hero />
        <Convergence />
        <AboutImages />
